...
L.opt_trackAllCandidates_name = "Record All Candidates"
L.opt_trackAllCandidates_desc = "Record every candidate's response for each item in the loot history, not just the winner's."
L.opt_trackCouncilVotes_name = "Record Council Votes"
L.opt_trackCouncilVotes_desc = "Also record which council members voted for each candidate. Requires 'Record All Candidates'."
